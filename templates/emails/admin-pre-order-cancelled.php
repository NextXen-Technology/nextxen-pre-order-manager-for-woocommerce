...
printf( esc_html__( 'A pre-order from %s has been cancelled. The order details are shown below for your reference.', 'nextxen-pre-order-manager' ), esc_html( $full_name ) );
?>
</p>
