...
printf( esc_html__( 'You have received a pre-order from %s. Their pre-order is as follows:', 'nextxen-pre-order-manager' ), $full_name ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
?>
</p>
